...
import { Share2, ThumbsDown, ThumbsUp, Copy, X } from "lucide-react";
...
export default function Card({ post }: { post: Post }) {
  ...
  const handleLike = async () => {
    try {
      ...
      if (res?.success) revalidateTags(["posts"]);
    } catch (error) {
      console.error(error);
    }
  };
  ...
  const shareUrl =
    typeof globalThis !== "undefined" && globalThis.location
      ? `${globalThis.location.origin}/community`
      : "";
  ...
  const openShareLink = (url: string) => {
    globalThis.open(url, "_blank", "width=600,height=400");
  };
      ...
      <div className="w-full max-w-2xl mx-auto rounded-xl border bg-card p-6 shadow-sm">
        ...
        <div className="mb-4 flex items-center gap-3">
          <svg
            ...
            fill="none"
          >
            <rect y="0.5" width="20" height="20" rx="10" fill="url(#paint0)" />
            <path
            ...
            />
            <defs>
              <linearGradient id="paint0" x1="10" y1="0.5" x2="10" y2="20.5">
        ...
        <DialogContent className="max-w-sm rounded-2xl">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 pt-2">
            ...
            <Button
              ...
              className="bg-gray-200 hover:bg-gray-300 text-gray-800 sm:col-span-3"
            >
