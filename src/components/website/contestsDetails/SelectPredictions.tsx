  ...
  return (
    <Card className="w-full max-w-4xl mx-auto pt-6 pb-0 border border-[#E6EBE8] shadow-none rounded-3xl gap-0">
      ...
      <div className="flex gap-4 bg-[#F2F7F5] px-6 pt-3 pb-5">
        <Badge
          variant="secondary"
          className="bg-[#E6EBE8] py-2 px-3 text-sm text-[#717A75] rounded-xl"
        >
        ...
        {filteredItems.map((item) => {
          ...
          return (
            <button
              ...
              className={cn(
                "relative h-12 rounded-lg border-2 transition-all duration-200 font-medium text-sm",
      ...
      <div className="flex items-center justify-between p-6 border-t">
        ...
        <div className="flex items-center gap-4">
          ...
          <Button className="bg-[#004721] h-12 px-4 text-base font-bold hover:bg-primary/90 text-primary-foreground rounded-2xl">
            Continue
          </Button>
        </div>
      </div>
